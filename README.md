...
- Refresh Token은 crypto.randomBytes(32) 기반으로 생성하였습니다. (ex. crypto.randomBytes(32).toString('base64url'))
- DB에는 crypto.createHash('sha256') 해시로 저장 -> sha256 사용 이유: 빠르고, 단방향이므로 복호화 불가
